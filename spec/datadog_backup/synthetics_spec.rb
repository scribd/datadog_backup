...
describe DatadogBackup::Synthetics do
  ...
  describe '#backup' do
    ...
    it 'is expected to create a file' do
      ...
      expect(file).to receive(:write).with(::JSON.pretty_generate(synthetic_description))
